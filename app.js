...
function FillStudentList() {
	...
	for (var i = 0; i < StoredStudentsData.length; i++) {
		...
		cell6.innerHTML = '<button class="btn btn-danger btn-sm float-center remove" onclick="DelRow(this)"><i class="fas fa-user-minus"></i></button>';
	}

}

function makeLink() {
    document.getElementById("link").setAttribute("href", "https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.13.0/js/all.min.js",); 
}
